...
public partial class PrintOrder : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        var data = db.Orders.Select(d => new { d.Id, d.OrderDate, d.GrandTotal, d.Customer.CName, d.Customer.Address }).Where(a => a.Id == inVNo).FirstOrDefault();

        if (data != null)
        {
            lblInvoice.Text = data.Id.ToString();
            lblCustomer.Text = data.CName;
