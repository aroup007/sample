...
<body>
    <form id="form1" runat="server">
        ...
        <div id="printreport">
            ...
            <h1 class="text-center alert-light bg-dark text-light"><u><b>Emperio Armani</b></u></h1>
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-stripped" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" ShowFooter="True">
                <Columns>
